...
const AuthPages = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-linear-to-br from-gray-600 via-zinc-600 to-gray-700 flex items-center justify-center p-4 w-full overflow-hidden">
            ...
            <div className="p-6 md:p-6 flex flex-col justify-center">
              ...
              <form onSubmit={handleSignup} className="space-y-5">
                ...
                <div className="relative">
                  ...
                  >
                    {toggle ? <Eye className="w-5 h-5 cursor-pointer" /> : <EyeOff className="w-5 h-5 cursor-pointer" />}
                  </button>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <button onClick={handleGoogle} className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                  ...
                  <button onClick={handleGithub} className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
