          ...
          <div className="grid md:grid-cols-2 min-h-[600px]">
              ...
              <div className="relative z-10 text-center">
                <div className="mb-8">
                  ...
                  <p className="text-lg text-white/90 max-w-md mx-auto leading-relaxed">
                    {isLogin
                      ? "Bring all your ideas, notes, and links back where they belong."
            ...
            <div className="p-6 md:p-6 flex flex-col justify-center">
              ...
              <form onSubmit={handleSignup} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="cursor-pointer w-full bg-linear-to-r from-neutral-900 via-neutral-800 to-neutral-700 text-white py-3.5 rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition-all flex items-center justify-center gap-2 group"
                >
              ...
              <div className="mt-8">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <button
                    ...
                    className="cursor-pointer flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
                  >
